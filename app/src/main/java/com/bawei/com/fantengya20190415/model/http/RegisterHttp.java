...
/**
 * @Auther: 樊腾亚
 * @Date: 2019/4/15 10:08:09
 * @Description:
 */
public class RegisterHttp {
    //单例
    private static RegisterHttp http;
    private static String TAG = ".http";
    private RegisterHttp(){};
    public static RegisterHttp getInstance(){
        if (http == null){
            synchronized (RegisterHttp.class){
                if (http == null){
                    http = new RegisterHttp();
                }
            }
        }
        return http;
    ...
    //异步请求
    public static void getAsyncTask(String url, final String phone, final String pwd, final Http.CallBack callBack){
